...
AVMAllyAIController::AVMAllyAIController()
{
...
void AVMAllyAIController::OnPossess(APawn* InPawn)
{
...
void AVMAllyAIController::OnUnPossess()
{
...
void AVMAllyAIController::RunAI()
{
	// 블랙보드 컴포넌트 포인터 가져오기.
...
void AVMAllyAIController::StopAI()
{
